    ...
    <article className="overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm">
      ...
      <div className="grid grid-cols-2 border-t border-border/60 bg-muted/20 sm:grid-cols-4">
        ...
        <Button
          ...
          className="h-auto flex-col gap-1.5 rounded-none border-r border-border/60 px-2 py-3 text-[0.7rem] font-semibold uppercase tracking-wide text-muted-foreground hover:bg-muted/40 hover:text-foreground disabled:opacity-50"
          title={
